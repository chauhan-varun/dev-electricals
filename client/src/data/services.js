...
export const repairs = [
  {
    id: 1,
    category: 'Fan Repair',
    description: 'Expert repair services for ceiling fans, exhaust fans, and industrial fans.',
    price: 'From ₹100',
    commonIssues: [
      'Motor problems',
  ...
  },
  {
    id: 2,
    category: 'AC Repair',
    description: 'Repairs your AC as it was when you bought it',
    price: 'From ₹400',
    commonIssues: [
      'Starting problems',
      'Power output issues',
  ...
  {
    id: 3,
    category: 'Circuit Fixing',
    description: 'Professional diagnosis and repair of electrical circuit issues.',
    price: 'From ₹100',
    commonIssues: [
      'Short circuits',
