    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          <h2 className="text-xl font-semibold text-gray-800 mb-2">No products found matching your criteria</h2>
          <p className="text-gray-600">Try changing your search filters or check back later!</p>
        </div>
      ) : (
